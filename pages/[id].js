    ...
    <div>
      <div className="bg-black min-h-screen text-[#E7E9EA] max-w-[1400px] mx-auto flex">
        ...
        <div className="sm:ml-16 xl:ml-80 max-w-2xl flex-grow border-gray-700 border-x">
          <div className="px-3 py-2 text-lg sm:text-xl font-bold border-b border-gray-700 sticky top-0 z-50 flex space-x-2 bg-black">
            <Link href={"/"}>
          ...
          {tweetData.comments?.map((comment) => (
            <div key={comment.id} className="border-b border-gray-700">
              <div className="flex space-x-3 p-3">
                <img
                  className="w-11 h-11 rounded-full object-cover"
